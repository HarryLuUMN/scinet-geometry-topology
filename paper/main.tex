...
Figure~\ref{fig:innovation_regimes} visualizes this regime structure. The heatmap bins papers by topological opportunity and spectral connectivity and plots the share that become top-five-percent breakthrough papers. The right panel collapses the same two-dimensional map into four regime-level breakthrough rates. The intended interpretation is not that all novelty is valuable. Breakthrough science is concentrated where unresolved high-order structure is paired with enough spectral connectivity for the idea to travel.
