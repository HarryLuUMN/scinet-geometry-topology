...
\subsection{Innovation, recombination, and the direction of search}

This paper is related first to the economics of innovation and knowledge recombination. A central idea in this literature is that new ideas are produced by combining existing ideas, but that not all combinations have the same value. \citet{weitzman1998recombinant} formalizes growth as a recombinant process, while \citet{fleming2001recombinant} shows that new technological combinations increase uncertainty and upper-tail outcomes. Work on local search and boundary-spanning exploration emphasizes that search is shaped by technological and organizational boundaries \citep{rosenkopf2001beyond}. Science can also guide technological search by helping inventors navigate complex combinatorial spaces \citep{fleming2004science}. In science itself, atypical combinations are associated with high impact \citep{uzzi2013atypical}, while research strategies trade off tradition and risky innovation \citep{foster2015tradition}. Related work also studies the burden of expanding knowledge and the network structure of innovation across technology classes \citep{jones2009burden,acemoglu2016innovation}. This literature motivates the view that scientific search is structured by the existing knowledge environment.
...
\subsection{Science of science and bibliographic networks}

The paper also contributes to the science-of-science literature. \citet{fortuna2020science} synthesize evidence that scientific production is shaped by teams, institutions, careers, fields, and networks. A large body of work uses collaboration and citation networks to study the organization of scientific production, including the structure of collaboration networks \citep{newman2001structure}, the growing role of teams \citep{wuchty2007increasing}, paper-level citation dynamics \citep{wang2013quantifying}, and scientist-level impact trajectories \citep{sinatra2016quantifying}. Large-scale bibliographic graphs such as Microsoft Academic Graph and OGBN-MAG make it possible to measure these structures at scale \citep{sinha2015overview,hu2020ogb}. Existing work often represents science as citation, collaboration, or topic networks, and uses these networks to study scientific influence, diffusion, collaboration, and field structure.
...
\subsection{Topological, spectral, and geometric methods}

Finally, the paper connects innovation measurement to topological data analysis, graph geometry, and spectral graph theory. Persistent homology provides tools for measuring connected components, cycles, and higher-order cavities in filtered spaces \citep{edelsbrunner2002topological,zomorodian2005computing}. Broader introductions to topological data analysis emphasize that topology can summarize the shape of complex data beyond pairwise distances or centrality measures \citep{ghrist2008barcodes,carlsson2009topology}. Spectral graph theory studies how Laplacian eigenvalues summarize connectivity and diffusion in graphs \citep{chung1997spectral}. Discrete curvature offers another way to identify bridge-like or high-load regions of a graph \citep{forman2003bochner}. These tools are widely used to describe the shape and connectivity of complex data.

The distinction in this paper is that these mathematical tools are given an economic interpretation and linked to scientific outcomes. Betti numbers and persistence diagrams are used to describe knowledge holes, Laplacian spectra are used to measure local diffusion capacity, and Forman curvature is used to identify bridge-like topic pairs. The empirical contribution is to show that these measurements are not only descriptive summaries of a graph. They define innovation regimes, predict future scientific impact, and support a causal-style exposure design based on lagged external topology shocks.

\section{Mathematical Toolkit and Conceptual Framework}
...
\subsection{Homology, persistence, spectra, and curvature}

Homology summarizes the shape of a complex. The Betti number $\beta_0$ counts connected components. $\beta_1$ counts loops or holes. $\beta_2$ counts higher-dimensional cavities. In economic terms, these quantities describe whether a local knowledge neighborhood is fragmented, whether there are missing higher-order combinations, and whether the neighborhood contains unresolved structure. Persistent homology extends this idea across a filtration, asking which holes remain visible as weaker knowledge ties are gradually admitted.
...
\subsection{Paper-level measures}
